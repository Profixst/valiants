        ...
        <div class="form-buttons">
            <div class="loading-indicator-container">
                <button
                    ...
                    data-load-indicator="<?= e(trans('profixs.valiants::lang.system.labels.saving_group')) ?>"
                ...
                <button
                    ...
                    data-load-indicator="<?= e(trans('profixs.valiants::lang.system.labels.deleting_group')) ?>"
                    data-request-confirm="<?= e(trans('profixs.valiants::lang.system.alerts.group_delete_confirm')) ?>">
                </button>
                <span class="btn-text">
